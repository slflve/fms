                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            <div class="brand-logo">
                                ...
                                <span class="fw-bold " style="font-family: sans-serif;"> <span
                                        class="fs-1 font-effect-shadow">File Management System</span> </span>
                            </div>
                            <h4>Hello! let's get started</h4>
                            <h6 class="fw-light">Sign in as an Admin <a href="login.php" class="text-primary">here</a></h6>
